export const scrambleTypes = [
  '3bld', '3bld_edges', '3bld_corners', '4bld', '4bld_centers', '4bld_wings', '5bld', '5bld_edges_corners'
];
...
export const tCenterBufferOptions = ['Uf', 'Ub', 'Ur', 'Ul'];
export const parityOptions = ['random', 'yes', 'no'];